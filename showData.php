...
<div class="card" style="width: 25rem; high: 25rem;">
  <div class="card-body">
    ...
    if (($num > 100) || ($num < 0)) {
        ...
        print "เกรดที่ได้  :  A  <font color=\"blue\"> ผ่าน" . '';
    } else if (($num >= 74.5) && ($num <= 79.4)) {
        print "เกรดที่ได้  :  B+  <font color=\"blue\"> ผ่าน" . '';
    } else if (($num >= 69.5) && ($num <= 74.4)) {
        print "เกรดที่ได้  :  B  <font color=\"blue\"> ผ่าน" . '';
    } else if (($num >= 64.5) && ($num <= 69.4)) {
        print "เกรดที่ได้  :  C+  <font color=\"blue\"> ผ่าน" . '';
    } else if (($num >= 59.5) && ($num <= 64.4)) {
        print "เกรดที่ได้  :  C  <font color=\"blue\"> ผ่าน" . '';
    } else if (($num >= 54.5) && ($num = 59.4)) {
        print "เกรดที่ได้  :  D+  <font color=\"blue\"> ผ่าน" . '';
